...
Ans: keeping the same topic is not supported operation. The lastest Kafka versions have the the option called topic deletion where you can delete the old topic and create a new one with new name.
